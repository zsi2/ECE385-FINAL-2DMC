...
set_fileset_property quartus_synth TOP_LEVEL VGA_SINK
set_fileset_property quartus_synth ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property quartus_synth ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file VGA_SINK.v VERILOG PATH VGA_SINK.v
...
set_fileset_property sim_verilog TOP_LEVEL VGA_SINK
...
# parameters
# 
add_parameter SYMBOLS_PER_BEAT INTEGER 2 ""
set_parameter_property SYMBOLS_PER_BEAT DEFAULT_VALUE 2
...
add_interface_port avalon_streaming_sink data_in data Input 32
...
add_interface_port conduit_end vga_clk export_vga_clk Output 1
add_interface_port conduit_end vga_hs export_vga_hs Output 1
add_interface_port conduit_end vga_vs export_vga_vs Output 1
add_interface_port conduit_end vga_de export_vga_de Output 1
add_interface_port conduit_end vga_r export_vga_r Output 8
add_interface_port conduit_end vga_g export_vga_g Output 8
add_interface_port conduit_end vga_b export_vga_b Output 8
